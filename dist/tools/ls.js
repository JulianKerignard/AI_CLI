...
export const lsTool = {
    name: "Ls",
    description: "Liste le contenu d'un répertoire avec taille et type (d=dir, f=fichier). Ignore node_modules/.git par défaut.",
